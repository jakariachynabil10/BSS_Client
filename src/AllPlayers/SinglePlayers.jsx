...
const SinglePlayers = () => {
  ...
  console.log(data);
  const { name, _id, Device, GameId, img, dateOfBirth, JoinedClubDate } = data;
  return (
    <div className="drawer lg:drawer-open">
      <input id="my-drawer-2" type="checkbox" className="drawer-toggle" />
      <div className="drawer-content flex flex-col items-center justify-center">
        {/* Page content here */}
        <div className="lg:hidden text-center pb-10">
          <img src={img} alt="Player" className="rounded-full p-5" />
